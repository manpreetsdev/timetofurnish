...
class HomeController extends Controller
{
    ...
    public function product(Request $request, $slug)
    {
        ...
        $detailedProduct  = Product::with('reviews', 'brand', 'stocks', 'taxes', 'thumbnail', 'user', 'user.shop', 'categories', 'main_category')->where('auction_product', 0)->where('slug', $slug)->first();
