@php
    ...
    $widgetLibrary = [
        'header_widget' => [
            ...
            'icon' => 'las la-heading',
            'description' => translate('Heading block'),
        ],
        'rich_text' => [
...
<div class="card-header px-0 pt-4">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
        <div>
            ...
            <p class="mb-0 text-muted">{{ translate('Create page layout sections first, then drag widgets from the sidebar into columns.') }}</p>
        </div>
    </div>
</div>
...
<div class="card-body px-0">
    <div class="ttf-builder-shell">
        <div class="ttf-editor-layout" data-page-builder-layout>
                    ...
                    <div class="ttf-editor-toolbar__actions">
                        <div class="ttf-editor-toolbar__cluster">
                            ...
                            <button type="button" class="btn btn-soft-primary" data-toggle-page-sidebar>
                                ...
                                <span data-sidebar-toggle-label>{{ translate('Hide Page Settings') }}</span>
                            </button>
                        </div>
            ...
            <aside class="ttf-editor-sidebar" data-page-sidebar>
                <div class="ttf-sidebar-tabs">
                    <button type="button" class="ttf-sidebar-tab-btn active" data-tab-target="widgets-tab">
                        <i class="las la-cubes"></i>
                        <span>{{ translate('Widgets') }}</span>
                    </button>
                    <button type="button" class="ttf-sidebar-tab-btn" data-tab-target="settings-tab">
                        <i class="las la-cog"></i>
                        <span>{{ translate('Settings') }}</span>
                    </button>
                </div>

                <div class="ttf-sidebar-tab-content active" id="widgets-tab" data-tab-content>
                    <div class="ttf-sidebar-section-title">
                        <h6>{{ translate('Widget Elements') }}</h6>
                        <p class="text-muted small mb-0">{{ translate('Drag widgets directly from here into a column on the canvas.') }}</p>
                    </div>
                ...
                <div class="ttf-sidebar-tab-content" id="settings-tab" data-tab-content>
                    <!-- Active settings header and portal container -->
                    <div class="ttf-active-settings-header d-none" id="active-settings-header">
                        ...
                        <button type="button" class="btn btn-xs btn-soft-secondary d-flex align-items-center gap-1" id="close-active-settings">
                            <i class="las la-times"></i> {{ translate('Close') }}
                        </button>
                    </div>
                    <div id="active-settings-portal-target" class="ttf-active-settings-portal-target d-none"></div>

                    <!-- Default page-wide settings stacked wrapper -->
                    <div class="ttf-sidebar-stack" id="default-page-settings">
                        <div class="card ttf-builder-card ttf-builder-card--sticky mb-3">
                            ...
                            <div class="card-body">
                                <div class="ttf-sidebar-note mt-0 mb-3">
                                    ...
                                    {{ translate('Drag elements from the widgets panel. Use this settings panel to adjust banner, styling, and page metadata.') }}
                                </div>
                                <button type="submit" class="btn btn-primary btn-block btn-lg">{{ $isEdit ? translate('Update Page') : translate('Save Page') }}</button>
                            </div>
                        </div>

                        <div class="card ttf-builder-card mb-3" data-page-settings-card>
                            <div class="card-header">
                        ...
                        <div class="card ttf-builder-card mb-0" data-page-settings-card>
                            <div class="card-header">
