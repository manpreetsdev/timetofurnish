...
<style>
    ...
    .category-pills-viewport::-webkit-scrollbar {
        display: none;
    }
    ...
    .category-section-card .slick-list {
        margin: 0 -8px !important;
    }

    .category-section-card .slick-slide {
        ...
        <div class="row">
            ...
            <div class="col-md-12 category-section" id="category-{{ $category->id }}">
                <div class="category-section-card">
                    ...
                    $showCards = in_array($categoryName, [
                    'bed and bedroom',
                    'sofas and chairs'
                    ]);
                    @endphp
                    ...
                    <div class="aiz-carousel border-right-0"
                        ...
                        $img_url = $img_id
                        ? uploaded_asset($img_id)
                        : static_asset('assets/img/default_subcategory.jpg');
                        @endphp
                    ...
                    <div class="coming-soon-box" style="background: #fdf1e7;">
                        @if (!empty($category->coming_soon_image) && uploaded_asset($category->coming_soon_image))
                            <div class="w-100 text-center py-2">
                                <img src="{{ uploaded_asset($category->coming_soon_image) }}"
                                     ...
                                     style="max-height: 350px; width: fit-content !important; object-fit: cover; border-radius: 12px;">
                            </div>
                        @else
