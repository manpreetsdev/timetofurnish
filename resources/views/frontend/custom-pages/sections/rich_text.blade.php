...
<section class="ttf-story-section ttf-story-section--rich-text {{ $alignmentClass }} {{ $visibilityClasses }}" style="
    ...
    --section-max-width: {{ max(40, min(100, (int) ($section['max_width'] ?? 100))) }}%;
