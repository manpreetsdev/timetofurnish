                                            ...
                                            @elseif ($wType == 'my_account')
                                                <ul class="list-unstyled">
                                                    ...
                                                    @else
                                                        @auth
                                                            <li class="mb-2 pb-2">
                                                                <a class="fs-14 text-light animate-underline-white" href="{{ route('logout') }}" rel="nofollow">{{ !empty($w['logout_text']) ? translate($w['logout_text']) : translate('Logout') }}</a>
                                                            </li>
                                                            <li class="mb-2 pb-2">
                                                                <a class="fs-14 text-light animate-underline-white" href="{{ route('purchase_history.index') }}" rel="nofollow">{{ !empty($w['order_history_text']) ? translate($w['order_history_text']) : translate('Order History') }}</a>
                                                            </li>
                                                            <li class="mb-2 pb-2">
                                                                <a class="fs-14 text-light animate-underline-white" href="{{ route('wishlists.index') }}" rel="nofollow">{{ !empty($w['wishlist_text']) ? translate($w['wishlist_text']) : translate('My Wishlist') }}</a>
                                                            </li>
                                                        @else
                                                            <li class="mb-2 pb-2">
                                            ...
                                            @else
                                                <ul class="footer-social-list mt-2">
                                                    ...
                                                    @foreach(($w['extra_social'] ?? []) as $sItem)
                                                        @if(!empty($sItem['url'] ?? ''))
                                                            <li><a href="{{ $sItem['url'] }}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a></li>
                                                        @endif
                                                    @endforeach
                                                </ul>
                                            @endif
