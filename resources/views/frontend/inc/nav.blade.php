    ...
    <div class="position-relative logo-bar-area py-2 border-bottom border-md-nonea z-1025">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="footer-top d-flex align-items-center justify-content-end lg:mr-5">
...
<style>
    ...
    /* Override the default transform to open from top */
    .aiz-top-menu-sidebar .collapse-sidebar.mobile-menu-drawer {
    ...
    .aiz-top-menu-sidebar.active .collapse-sidebar.mobile-menu-drawer {
    ...
    .mobile-menu-drawer {
        ...
        border-bottom: 1px solid #d8c8b7 !important;
        box-shadow: 0 18px 42px rgba(79, 66, 56, 0.18) !important;
        padding: 0 !important;
    ...
    .mobile-menu-list li.mobile-menu-account-item {
    ...
    .mobile-menu-list li a.logout-link:hover {
        ...
        border-left-color: #b92c2a !important;
    }
...
<script type="text/javascript">
    function show_order_details(order_id) {
        ...
        // Fixed the route name to avoid auto-formatter breaking it
        let detailsUrl = '{{ route("orders.details") }}';
        $.post(detailsUrl, {
