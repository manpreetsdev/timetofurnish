            ...
            <div class="shadow-sm p-0 p-lg-4 bg-white maincontainer">
                <div class="mb-4">
                    ...
                    <ul class="list-group list-group-flush px-0 cart-list-responsive">
                        ...
                        ->first();
                        // real max the shopper can order for this line (handles
                        // multi-attribute variants with no combined stock row)
                            ...
                            <div class="row align-items-center d-none d-lg-flex p-4 desktop-cart-card position-relative"
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <div class="fs-12 mt-2 text-secondary">{{ $available_qty }} {{ translate('available') }}</div>
                                        @else
