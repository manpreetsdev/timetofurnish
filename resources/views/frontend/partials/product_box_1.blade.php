    ...
    <div class="position-relative h-140px h-md-200px img-fit overflow-hidden">
        ...
        @if ($product->auction_product == 0)
            ...
            <div class="absolute-top-right aiz-p-hov-icon">
                <button type="button" class="hov-svg-white border-0 bg-transparent p-0" onclick="addToWishList({{ $product->id }})"
                    data-toggle="tooltip" title="{{ translate('Add to wishlist') }}" aria-label="{{ translate('Add to wishlist') }}" data-placement="left">
                ...
                <button type="button" class="hov-svg-white border-0 bg-transparent p-0" onclick="addToCompare({{ $product->id }})"
                    data-toggle="tooltip" title="{{ translate('Add to compare') }}" aria-label="{{ translate('Add to compare') }}" data-placement="left">
            ...
            <!-- add to cart -->
            <button type="button" class="border-0 cart-btn absolute-bottom-left w-100 h-35px aiz-p-hov-icon text-white fs-13 fw-700 d-flex flex-column justify-content-center align-items-center @if (in_array($product->id, $cart_added)) active @endif"
