<a href="{{ Auth::check() ? route('wishlists.index') : route('user.login') }}" class="d-flex align-items-center text-dark" data-toggle="tooltip" data-title="{{ translate('Wishlist') }}" data-placement="top" @guest rel="nofollow" @endguest>
