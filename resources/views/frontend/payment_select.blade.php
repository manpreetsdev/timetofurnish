                ...
                <div class="col-lg-6">
                    <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST"
                        ...
                        <div class="card rounded-0 border shadow-none">
                            ...
                            <!-- Payment Options -->
                            <div class="card-body text-center px-0 pt-1 pb-0">
                                <div class="container">
                                    <!-- Paypal -->
                                    @if (get_setting('paypal_payment') == 1)
                                    <div class="col-6 col-xl-3 col-md-4">
                                        <label class="aiz-megabox d-block mb-1">
                                            <input value="paypal" class="online_payment" type="radio"
                                                name="payment_option" checked>
                                            <span class="d-block aiz-megabox-elem rounded-0 p-0">
        ...
        function use_wallet() {
            ...
            if ($('#agree_checkbox').is(":checked")) {
                ...
                AIZ.plugins.notify('danger', '{{ translate('
                    You need to agree with our policies ') }}');
            }
        }
        ...
        function submitOrder(el) {
            ...
            if ($('#agree_checkbox').is(":checked")) {
                if (minimum_order_amount_check && $('#sub_total').val() < minimum_order_amount) {
                    ...
                    var offline_payment_active = '{{ addon_is_activated('
                    offline_payment ') }}';
