...
<div class="row row-cols-xxl-4 row-cols-xl-3 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 gutters-16 mb-4 wishlist-grid-row">
...
<!-- =========================================
     EMPTY WISHLIST
========================================= -->
<div class="row" id="wishlist-empty-container">
    <div class="col">
